...
public class OPiece extends Piece {
	...
	protected void setElements(Coordonnees coordonnees, Couleur couleur) {
		...
		if (this.getElements().size() == 0 ) {
			...
			this.getElements().set(2,new Element(new Coordonnees(abscisse+1,ordonnee),   couleur));
			this.getElements().set(3,new Element(new Coordonnees(abscisse+1,ordonnee-1),   couleur));
		}
