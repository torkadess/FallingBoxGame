...
public class ZPiece extends Piece {
	...
	protected void setElements(Coordonnees coordonnees, Couleur couleur) {
		...
		if (this.getElements().size() == 0 ) {
			...
			this.getElements().add(new Element(new Coordonnees(abscisse -1,ordonnee-1),   couleur));
			...
			this.getElements().set(1,new Element(new Coordonnees(abscisse -1,ordonnee-1),   couleur));
			this.getElements().set(2,new Element(new Coordonnees(abscisse,ordonnee-1),   couleur));
